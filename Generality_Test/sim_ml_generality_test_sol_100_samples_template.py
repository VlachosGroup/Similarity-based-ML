...
# load your data 
data = pd.read_csv('Data/curated_solubility_dataset_CHO_cleaned_060724.csv')
X = pd.read_csv('Data/descriptors_curated_solubility_dataset_CHO_cleaned_060724.csv').iloc[:,1:]
...
def parallelize_benchmarking(seed1, seed2,  data, X, target, best_nn, scaler, tl_feats):
    ...
    with open(f"sim_ml_generality_results/result_sol_sample_{seed1 + 1}_{seed2 + 1}.pkl", "wb") as f:
        pickle.dump(results, f)

# Define your seeds and partition them; you can do it however you want accordingly w/ your compuataitonal resources
n_partitions = 10
partition_number = 1
...
Parallel(n_jobs=-1, verbose=5)(
    delayed(parallelize_benchmarking)(seed1, seed2, data, X, 'Solubility', best_nn, scaler_Cv, Cv_feats) 
